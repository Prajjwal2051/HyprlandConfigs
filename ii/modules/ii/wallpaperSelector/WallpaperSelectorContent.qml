...
MouseArea {
    ...
    property string wallpaperTarget: "background" // "background" or "lockscreen"
    ...
    function selectWallpaperPath(filePath) {
        if (filePath && filePath.length > 0) {
            if (root.wallpaperTarget === "lockscreen") {
                Config.options.lock.wallpaperPath = filePath;
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        // Target selector with aesthetic design
                        Rectangle {
                                    ...
                                    RippleButton {
                                        ...
                                        contentItem: Column {
                                            ...
                                            MaterialSymbol {
                                                ...
                                                fill: root.wallpaperTarget === "background" ? 1 : 0
                                                color: root.wallpaperTarget === "background" ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer2
                                            }
                                            StyledText {
                                                anchors.horizontalCenter: parent.horizontalCenter
                                                text: Translation.tr("Background")
                                                font.pixelSize: Appearance.font.pixelSize.smaller
                                                font.weight: root.wallpaperTarget === "background" ? Font.Medium : Font.Normal
                                                color: root.wallpaperTarget === "background" ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer2
                                            }
                                        }
                                    }
                                    ...
                                    RippleButton {
                                        ...
                                        contentItem: Column {
                                            ...
                                            MaterialSymbol {
                                                ...
                                                text: "lock"
                                                iconSize: Appearance.font.pixelSize.normal
                                                fill: root.wallpaperTarget === "lockscreen" ? 1 : 0
                                                color: root.wallpaperTarget === "lockscreen" ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer2
                                            }
                                            StyledText {
                                                anchors.horizontalCenter: parent.horizontalCenter
                                                text: Translation.tr("Lock Screen")
                                                font.pixelSize: Appearance.font.pixelSize.smaller
                                                font.weight: root.wallpaperTarget === "lockscreen" ? Font.Medium : Font.Normal
                                                color: root.wallpaperTarget === "lockscreen" ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer2
                                            }
                                        }
                                    }
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    GridView {
                        ...
                        bottomMargin: extraOptions.implicitHeight + 24
                        ...
                        delegate: WallpaperDirectoryItem {
                            ...
                            property bool isCurrentBackground: fileModelData.filePath === Config.options.background.wallpaperPath
                            property bool isCurrentLockscreen: fileModelData.filePath === Config.options.lock.wallpaperPath
                            property bool isActiveWallpaper: (root.wallpaperTarget === "background" && isCurrentBackground) || (root.wallpaperTarget === "lockscreen" && isCurrentLockscreen)
                            
                            colBackground: (index === grid?.currentIndex || containsMouse) ? Appearance.colors.colPrimary : isActiveWallpaper ? Appearance.colors.colSecondaryContainer : ColorUtils.transparentize(Appearance.colors.colPrimaryContainer)
                            colText: (index === grid.currentIndex || containsMouse) ? Appearance.colors.colOnPrimary : isActiveWallpaper ? Appearance.colors.colOnSecondaryContainer : Appearance.colors.colOnLayer0
                            
                            // Show indicator badges for active wallpapers
                            property bool showBackgroundBadge: isCurrentBackground
                            property bool showLockscreenBadge: isCurrentLockscreen
