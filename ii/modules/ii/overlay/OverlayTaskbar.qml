...
Rectangle {
    ...
    RowLayout {
        ...
        BackgroundWidgetButton {
            identifier: "music"
            materialSymbol: "graphic_eq"
            toggled: Config.options.background.widgets.music.enable
            onClicked: Config.options.background.widgets.music.enable = !Config.options.background.widgets.music.enable
            StyledToolTip {
                text: Translation.tr("Desktop music widget")
            }
        }
        ...
        BackgroundWidgetButton {
            ...
            toggled: Config.options.background.widgets.github.enable
            onClicked: Config.options.background.widgets.github.enable = !Config.options.background.widgets.github.enable
            StyledToolTip {
                text: Translation.tr("GitHub contributions heatmap")
            }
        }
        ...
        BackgroundWidgetButton {
            ...
            toggled: Config.options.background.widgets.solarSystem.enable
            onClicked: Config.options.background.widgets.solarSystem.enable = !Config.options.background.widgets.solarSystem.enable
            StyledToolTip {
                text: Translation.tr("Solar system")
            }
        }
    ...
    component BackgroundWidgetButton: RippleButton {
        id: backgroundWidgetButton
        required property string identifier
        required property string materialSymbol
        ...
        contentItem: Item {
            ...
            MaterialSymbol {
                anchors.centerIn: parent
                iconSize: 24
                text: backgroundWidgetButton.materialSymbol
                color: backgroundWidgetButton.toggled ? Appearance.colors.colOnSecondaryContainer : Appearance.colors.colOnSurfaceVariant
            }
        }
    }
}
