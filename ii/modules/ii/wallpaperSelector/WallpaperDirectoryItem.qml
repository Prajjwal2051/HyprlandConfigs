...
MouseArea {
    ...
    // Badge indicators for active wallpapers
    property bool showBackgroundBadge: false
    property bool showLockscreenBadge: false
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Row {
                    ...
                    // Background wallpaper badge
                    Rectangle {
                        visible: root.showBackgroundBadge
                        width: 28
                        height: 28
                        radius: 14
                    ...
                    // Lock screen wallpaper badge
                    Rectangle {
                        visible: root.showLockscreenBadge
                        width: 28
                        height: 28
                        radius: 14
